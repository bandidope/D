...
// <- TUS 2 LINKS DE CATBOX YA PUESTOS
const AUDIO_NORMAL = 'https://files.catbox.moe/sl8onr.mpeg' // Lunes-Sab
const AUDIO_DOMINGO = 'https://files.catbox.moe/in9kqq.mp3' // Domingo/Extra
...
.sorteo ver |.sorteo eliminar`)
  ...
  // <- BLOQUEA SOLO SI ES LUNES-SAB Y YA TIENE 3
  if(dia!== 'extra'){
